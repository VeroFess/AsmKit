...
typedef struct asmkit_target_ops {
    ...
    asmkit_status_t (*decode_one)(const asmkit_engine_t*, asmkit_workspace_t*, const uint8_t*, size_t, uint64_t, asmkit_inst_t*);
    asmkit_status_t (*analyze_inst)(const asmkit_engine_t*, asmkit_workspace_t*, const asmkit_inst_t*, asmkit_inst_semantics_t*);
    asmkit_status_t (*encode_inst)(const asmkit_engine_t*, asmkit_workspace_t*, const asmkit_inst_t*, const asmkit_encode_options_t*, uint8_t*, size_t, asmkit_encode_result_t*);
    asmkit_status_t (*emit_jump)(const asmkit_engine_t*, asmkit_workspace_t*, uint64_t, uint64_t, const asmkit_emit_options_t*, uint8_t*, size_t, asmkit_emit_result_t*);
    asmkit_status_t (*emit_call)(const asmkit_engine_t*, asmkit_workspace_t*, uint64_t, uint64_t, const asmkit_emit_options_t*, uint8_t*, size_t, asmkit_emit_result_t*);
    asmkit_status_t (*relocate_inst)(const asmkit_engine_t*, asmkit_workspace_t*, const asmkit_inst_t*, uint64_t, uint8_t*, size_t, asmkit_emit_result_t*);
    uint32_t (*min_patch_size)(const asmkit_engine_t*, uint64_t, uint64_t, asmkit_branch_mode_t, uint64_t*, uint64_t*);
    asmkit_status_t (*plan_jump_back)(const asmkit_engine_t*, asmkit_branch_mode_t, asmkit_branch_plan_bound_t*);
} asmkit_target_ops_t;
...
asmkit_status_t asmkit_gen_x86_decode_one(const asmkit_engine_t*, const uint8_t*, size_t, uint64_t, asmkit_inst_t*);
asmkit_status_t asmkit_gen_arm_decode_one(const asmkit_engine_t*, const uint8_t*, size_t, uint64_t, asmkit_inst_t*);
asmkit_status_t asmkit_gen_aarch64_decode_one(const asmkit_engine_t*, const uint8_t*, size_t, uint64_t, asmkit_inst_t*);
asmkit_status_t asmkit_gen_bpf_decode_one(const asmkit_engine_t*, const uint8_t*, size_t, uint64_t, asmkit_inst_t*);
asmkit_status_t asmkit_gen_wasm_decode_one(const asmkit_engine_t*, const uint8_t*, size_t, uint64_t, asmkit_inst_t*);

asmkit_status_t asmkit_gen_x86_emit_rel(const asmkit_engine_t*, int is_call, uint64_t, uint64_t, uint8_t*, size_t, asmkit_emit_result_t*);
asmkit_status_t asmkit_gen_aarch64_emit_rel(const asmkit_engine_t*, int is_call, uint64_t, uint64_t, uint8_t*, size_t, asmkit_emit_result_t*);
asmkit_status_t asmkit_gen_arm_emit_rel(const asmkit_engine_t*, int is_call, uint64_t, uint64_t, uint8_t*, size_t, asmkit_emit_result_t*);

asmkit_status_t asmkit_gen_x86_encode_inst(const asmkit_engine_t*, const asmkit_inst_t*, uint8_t*, size_t, asmkit_encode_result_t*);
asmkit_status_t asmkit_gen_aarch64_encode_inst(const asmkit_engine_t*, const asmkit_inst_t*, uint8_t*, size_t, asmkit_encode_result_t*);
asmkit_status_t asmkit_gen_aarch64_encode_fixed(const asmkit_engine_t*, const asmkit_inst_t*, uint8_t*, size_t, asmkit_encode_result_t*);
asmkit_status_t asmkit_gen_arm_encode_fixed(const asmkit_engine_t*, const asmkit_inst_t*, uint8_t*, size_t, asmkit_encode_result_t*);
asmkit_status_t asmkit_gen_arm_encode_inst(const asmkit_engine_t*, const asmkit_inst_t*, uint8_t*, size_t, asmkit_encode_result_t*);
asmkit_status_t asmkit_gen_bpf_encode_inst(const asmkit_engine_t*, const asmkit_inst_t*, uint8_t*, size_t, asmkit_encode_result_t*);
asmkit_status_t asmkit_gen_wasm_encode_inst(const asmkit_engine_t*, const asmkit_inst_t*, uint8_t*, size_t, asmkit_encode_result_t*);
