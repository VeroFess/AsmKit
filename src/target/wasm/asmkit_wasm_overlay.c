...
static asmkit_status_t wasm_decode(const asmkit_engine_t* ASMKIT_RESTRICT engine, asmkit_workspace_t* ASMKIT_RESTRICT workspace, const uint8_t* ASMKIT_RESTRICT code, size_t code_size, uint64_t address, asmkit_inst_t* ASMKIT_RESTRICT out_inst)
{
    (void)workspace;
    return asmkit_gen_wasm_decode_one(engine, code, code_size, address, out_inst);
}

static asmkit_status_t wasm_analyze(const asmkit_engine_t* ASMKIT_RESTRICT engine, asmkit_workspace_t* ASMKIT_RESTRICT workspace, const asmkit_inst_t* ASMKIT_RESTRICT inst, asmkit_inst_semantics_t* ASMKIT_RESTRICT out_semantics)
{
    (void)engine;
    (void)workspace;
...
static asmkit_status_t wasm_unsupported_emit(const asmkit_engine_t* ASMKIT_RESTRICT engine, asmkit_workspace_t* ASMKIT_RESTRICT workspace, uint64_t from_address, uint64_t to_address, const asmkit_emit_options_t* ASMKIT_RESTRICT options, uint8_t* ASMKIT_RESTRICT out_code, size_t out_capacity, asmkit_emit_result_t* ASMKIT_RESTRICT out_result)
{
    (void)engine;
    (void)workspace;
    (void)from_address;
...
static asmkit_status_t wasm_encode(const asmkit_engine_t* ASMKIT_RESTRICT engine, asmkit_workspace_t* ASMKIT_RESTRICT workspace, const asmkit_inst_t* ASMKIT_RESTRICT inst, const asmkit_encode_options_t* ASMKIT_RESTRICT options, uint8_t* ASMKIT_RESTRICT out_code, size_t out_capacity, asmkit_encode_result_t* ASMKIT_RESTRICT out_result)
{
    (void)workspace;
    (void)options;
...
static asmkit_status_t wasm_relocate(const asmkit_engine_t* ASMKIT_RESTRICT engine, asmkit_workspace_t* ASMKIT_RESTRICT workspace, const asmkit_inst_t* ASMKIT_RESTRICT inst, uint64_t relocated_address, uint8_t* ASMKIT_RESTRICT out_code, size_t out_capacity, asmkit_emit_result_t* ASMKIT_RESTRICT out_result)
{
    (void)engine;
    (void)workspace;
    (void)inst;
...
static uint32_t wasm_min_patch(const asmkit_engine_t* ASMKIT_RESTRICT engine, uint64_t from_address, uint64_t to_address, asmkit_branch_mode_t mode, uint64_t* ASMKIT_RESTRICT clobber_lo, uint64_t* ASMKIT_RESTRICT clobber_hi)
{
    (void)engine;
    (void)from_address;
    (void)to_address;
...
static asmkit_status_t wasm_plan_jump_back(const asmkit_engine_t* ASMKIT_RESTRICT engine, asmkit_branch_mode_t mode, asmkit_branch_plan_bound_t* ASMKIT_RESTRICT out_bound)
{
    (void)engine;
    (void)mode;
    if (out_bound != 0) {
